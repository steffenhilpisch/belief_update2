...
class Player(BasePlayer):
    ...
    # Memory questions
    belief_memory1 = models.IntegerField(doc='',
                                          label='At the end of the previous/last round (Round 3), what did you '
                                                'think were the chances (in %) that the BLUE URN was picked in the '
                                                'beginning?',
                                          min=0,
                                          max=100)
    belief_memory2 = models.IntegerField(doc='',
                                          label='At the end of the second to last round (Round 2), what did you think '
                                                'were the chances (in %) that the BLUE URN was picked in the '
                                                'beginning?',
                                          min=0,
                                          max=100)
    ...
    belief_optimal = models.IntegerField(doc='Subjective probability regarding optimality of own action',
                                         label='In theory, after each report that was shown to you it was possible to calculate '
                                               'the exact percentage chance the selected urn was blue. '
...
# PAGES
class MemoryQuestions(Page):
    form_model = 'player'
    form_fields = ['belief_memory1', 'belief_memory2']
...
class BeliefQuestions(Page):
    form_model = 'player'
    form_fields = ['belief_strategy', 'belief_optimal', 'belief_fake_blue', 'belief_fake_red']
...
page_sequence = [MemoryQuestions, Transition, BeliefQuestions, CRT, Demographics, FinalPage]
